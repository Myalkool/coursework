...
insert into employee (duration_app, full_name, job_title, work_start, work_end) VALUES
    (30, 'Иванов Иван Иванович', 'Кардиолог', '09:00:00', '18:00:00');
...
insert into employee (duration_app, full_name, job_title, work_start, work_end) VALUES
    (60, 'Демидов Дмитрий Сергеевич', 'Кардиолог', '13:00:00', '18:00:00');
...
insert into employee (duration_app, full_name, job_title, work_start, work_end) VALUES
    (45, 'Сергеева Ольга Валерьевна', 'Кардлог_хирург', '14:00:00', '20:00:00');

insert into employee(duration_app, full_name, job_title, work_start, work_end) VALUES
   (30, 'Петрунина Анастасия Андреевна', 'Кардиолог-хирург', '15:00:00', '21:00:00');
...
INSERT INTO good (active, name, price) VALUES
    ...
    (true, 'Узи сердца', 2500.0),
    (true, 'ЭКГ сердца', 500.0),
    (true, 'Эндоскопическое обследование', 3000);
